 ...
 * @LastEditTime: 2023-02-26 17:34:52
...
srcList = Array(5).fill(1).map((item, index) => require(`./../public/lf/lf_${index + 1}.jpeg`))
  second = ''
  minutes = ''
  day = ''
  months = ''
  year = ''
  imgSrc = this.srcList[0]
  date = '2023-02-26 07:38:00'
      ...
      if (min > 60) {
        ...
        if (hour > 24) {
          ...
          if (day > 365) {
            ...
            const year = parseInt(
              parseInt(parseInt(parseInt(second_time / 60) / 60) / 24) / 365,
            )
            time =
              year +
              '年' +
  ...
  countTime() {
    const beginLoveTime = dayjs('2023-02-26 07:38:00')
    const date2 = dayjs()
